...
@section('content')
    ...
    <div class="container-fluid">
        <div class="p-3">
            <form method="POST" action="{{ route('transfer_barang.storeDetailTransferBarang') }}" id="formTambah" novalidate>
                ...
                <button type="button" class="btn btn-success ml-2" data-toggle="modal" data-target="#modalTambahBarang" id="btnTambahBarangDipindah">Tambah</button>
    ...
    <script type="text/javascript">
        ...
        $('#btnTambahBarangDipindah').on('click', function() {
            ...
            $('#selectTglKadaluarsa').val("Pilih Tanggal Kadaluarsa").change();
            $('#jumlahDiGudang').val("");
            $('#jumlahDiRak').val("");
