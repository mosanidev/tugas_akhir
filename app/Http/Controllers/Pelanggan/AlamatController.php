...
class AlamatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelanggan.user_menu.user_menu', ['alamat'=>$alamat, 'semua_kategori' => $kategori, 'total_cart'=>$total_cart, 'jumlah_notif' => $jumlah_notif, 'jumlah_notif_belum_dilihat' => $jumlah_notif_belum_dilihat]);
